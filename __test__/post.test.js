...
describe('Test Post methods', function () {
    ...
    test('create post no data passed', function () {
        ...
        let newPost = Post.methods.createNewPost();
    ...
    test('create post with correct data', function () {
        let newUser = new User('joe', 'joe@gmail.com', 'passerby', 'user');
        newUser.createNewUser();
        let newPost = Post.methods.createNewPost('joe@gmail.com', 'passerby', 'Goodnews: God is Jesus!');
    ...
    test('create post with wrong data', function () {
        ...
        newUser.createNewUser();
        let newPost = Post.methods.createNewPost('kolo@gmail.com', 'passerby', 'Goodnews: God is Jesus!');
        expect(newPost).toBe('User not found, please signup and try again');
    });
});
...
describe('Test Read Post Methods', function () {
    test('view single post with no data passed', function () {
        ...
        newUser.createNewUser();
        let newPost = Post.methods.createNewPost('kolo@gmail.com', 'passerby', 'Goodnews: God is Jesus!');
        let readPost = Post.methods.readPostById();
    ...
    test('view single post by correct id', function () {
        ...
        newUser.createNewUser();
        let newPost = Post.methods.createNewPost('kolo@gmail.com', 'passerby', 'Goodnews: God is Jesus!');
        let readPost = Post.methods.readPostById('jo@gmail.com', 'passerby', 1);
...
describe('Test Read All Post Mehtod', function () {
    test('read all post with no user credentials', function () {
        let newUser = new User('joe', 'jo@gmail.com', 'passerby', 'user');
        newUser.createNewUser();
        Post.methods.createNewPost('koooo@gmail.com', 'passerby', 'Goodnews: God is Jesus!');
        Post.methods.createNewPost('joe@gmail.com', 'passerby', 'Goodnews: God is the Almighty!');
        let readPost = Post.methods.readAllPost();
    ...
    test('read all post with correct credentials', function () {
        ...
        newUser.createNewUser();
        Post.methods.createNewPost('koooo@gmail.com', 'passerby', 'Goodnews: God is Jesus!');
        let readPost = Post.methods.readAllPost('joe@gmail.com', 'passerby');
        expect(readPost).toBeDefined();
    });
});
...
describe('Test Delete Single Post Method', function () {
    test('delete post with no params passed', function () {
        ...
        newUser.createNewUser();
        Post.methods.createNewPost('koooo@gmail.com', 'passerby', 'Goodnews: God is Jesus!');
        let deletePost = Post.methods.deletePostById();
    ...
    test('delete post with no post id', function () {
        ...
        newUser.createNewUser();
        Post.methods.createNewPost('koooo@gmail.com', 'passerby', 'Goodnews: God is Jesus!');
        let deletePost = Post.methods.deletePostById('joe@gmail.com', 'passerby');
    ...
    test('delete post with correct id', function () {
        ...
        newUser.createNewUser();
        Post.methods.createNewPost('koooo@gmail.com', 'passerby', 'Goodnews: God is Jesus!');
        let deletePost = Post.methods.deletePostById('joe@gmail.com', 'passerby', 2);
...
describe('Test Delete All Post Method', function () {
    test('delete post with no params passed', function () {
        ...
        newUser.createNewUser();
        Post.methods.createNewPost('koooo@gmail.com', 'passerby', 'Goodnews: God is Jesus!');
        let deletePost = Post.methods.deleteAllPost();
        expect(deletePost).toBe('User does not exist, login to Delete a Post');
    });
    ...
    test('delete post with correct email, and password', function () {
        let newUser = new User('joe', 'jo@gmail.com', 'passerby', 'user');
        newUser.createNewUser();
        Post.methods.createNewPost('jo@gmail.com', 'passerby', 'Goodnews: God is Jesus!');
        Post.methods.createNewPost('jo@gmail.com', 'passerby', 'My friends surname!');
        let deletePost = Post.methods.deleteAllPost('jo@gmail.com', 'passerby');
...
describe('Test Comment Post Method', function () {
    test('Comment on post with no params passed', function () {
        ...
        newUser.createNewUser();
        let newPost = Post.methods.createNewPost('koooo@gmail.com', 'passerby', 'Goodnews: God is Jesus!');
        let newComment = Post.methods.commentPost();
    ...
    test('Comment on post with email and password', function () {
        ...
        newUser.createNewUser();
        let newPost = Post.methods.createNewPost('koooo@gmail.com', 'passerby', 'Goodnews: God is Jesus!');
        let newComment = Post.methods.commentPost('joe@gmail.com', 'passerby');
    ...
    test('Comment on post with email and password, post id and comment text', function () {
        let newUser = new User('joe', 'koooo@gmail.com', 'passerby', 'user');
        newUser.createNewUser();
        let newPost = Post.methods.createNewPost('koooo@gmail.com', 'passerby', 'Goodnews: Christ is risen!');
        let newComment = Post.methods.commentPost('joe@gmail.com', 'passerby', 4, 'Yes, he is the Almighty God');
...
describe('Test Clap For A Post Method', function () {
    test('clap for a post with no params passed', function () {
        ...
        newUser.createNewUser();
        let newPost = Post.methods.createNewPost('koooo@gmail.com', 'passerby', 'Goodnews: God is Jesus!');
        let clapForPost = Post.methods.clapForAPost();
    ...
    test('clap for a post with no post Id', function () {
        ...
        newUser.createNewUser();
        let newPost = Post.methods.createNewPost('koooo@gmail.com', 'passerby', 'Goodnews: God is Jesus!');
        let clapForPost = Post.methods.clapForAPost('joe@gmail.com', 'passerby');
    ...
    test('clap for a post with no post Id', function () {
        ...
        newUser.createNewUser();
        Post.methods.createNewPost('koooo@gmail.com', 'passerby', 'Goodnews: God is Jesus!');
        let ss = Post.methods.clapForAPost('joe@gmail.com', 'passerby', 2);
